      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h3 className="text-3xl md:text-5xl font-heading font-bold mb-6 text-foreground leading-tight">Ingeniería confiable para proyectos exitosos</h3>
            ...
            <div className="grid grid-cols-3 gap-6 pt-10 border-t border-white/10">
              <div>
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">Proyectos</p>
              </div>
              <div>
                <p className="text-4xl font-heading font-bold mb-1 text-primary">+50</p>
                <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">Clientes</p>
              </div>
              <div>
                <p className="text-4xl font-heading font-bold mb-1 text-primary">8</p>
                <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">Regiones</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {reasons.map((reason, index) => (
              <div key={index} className="bg-background border border-white/5 p-8 rounded-2xl hover:border-primary/30 transition-all duration-300">
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-6 text-primary">
                  {reason.icon}
                </div>
                <h4 className="text-xl font-heading font-bold mb-3 text-foreground">{reason.title}</h4>
